...
# ── VPC ──────────────────────────────────────────────────────────────
module "vpc" {
  source = "https://github.com/Rutuja509/terraform-module-vpc-main.git"
...
module "subnets" {
  source = "https://github.com/Rutuja509/terraform-module-subnet-main.git"
...
module "ec2_instances" {
  source = "https://github.com/Rutuja509/terraform-module-ec2-main.git"
...
# ── S3 Bucket ─────────────────────────────────────────────────────────
module "s3_bucket" {
  source = "https://github.com/Rutuja509/terraform-module-s3-main.git"
