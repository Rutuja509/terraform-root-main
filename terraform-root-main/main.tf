...
module "subnets" {
  source = "git::https://github.com/Rutuja50/terraform-module-subnet-main.git"
...
module "ec2_instances" {
  source = "git::https://github.com/Rutuja50/terraform-module-ec2-main.git"
...
# ── S3 Bucket ─────────────────────────────────────────────────────────
module "s3_bucket" {
  source = "git::https://github.com/Rutuja50/terraform-module-s3-main.git"
